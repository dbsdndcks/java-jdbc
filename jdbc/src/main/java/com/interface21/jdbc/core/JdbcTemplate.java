...
public class JdbcTemplate {
    ...
    private <T> void execute(SqlExecutor<T> executor) {
    ...
    private <T> void execute(Connection conn, SqlExecutor<T> executor) {
        try {
            executor.execute(conn);
        } catch (SQLException e) {
            log.error(e.getMessage(), e);
    ...
    public void executeUpdate(Connection connection, String sql, Object... params) {
        Object[] safeParams = (params == null) ? new Object[0] : params;
